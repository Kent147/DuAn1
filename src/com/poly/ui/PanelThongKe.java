...
public class PanelThongKe extends javax.swing.JPanel {
    ...
    private void thongKeChiTheoNgay() {
        Object object = thongKeDAO.sp_getTotalChi(07, today.getMonthValue(), today.getYear());
        if (object != null) {
    ...
    private void thongKeThuTheoNgay() {
        Object object = thongKeDAO.sp_getTotalThu(07, today.getMonthValue(), today.getYear());
        if (object != null) {
    ...
    private void thongKeUserChiTheoNgay() {
        Object object = thongKeDAO.sp_getUserChi(07, today.getMonthValue(), today.getYear());
        if (object != null) {
    ...
    private void thongKeUserThuTheoNgay() {
        Object object = thongKeDAO.sp_getUserThu(8, today.getMonthValue(), today.getYear());
        if (object != null) {
