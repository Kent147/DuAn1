...
import com.poly.model.ChiTietThuId;
 ...
 * @author THANHLONG
 */
public class FrameThemHoaDonThu extends javax.swing.JFrame {

    /**
     * Creates new form FrameThemHoaDonChi
     */
    public FrameThemHoaDonThu() {
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("  THÊM HOÁ ĐƠN THU");
        ...
        lblNgaychi.setText("Ngày Thu: ");

        lblNguoichi.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblNguoichi.setText("Người Thu:");
                    ...
                    .addGroup(pnlMainLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlMainLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(pnlMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtSotien, javax.swing.GroupLayout.DEFAULT_SIZE, 332, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameThemHoaDonThu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void init() {
        ...
        this.setTitle("THÊM HOÁ ĐƠN THU");
        loadLoaiChi();
    ...
    private void fillComboboxLoaiChi() {
        ...
        if (!listLoaiThu.isEmpty()) {
            for (LoaiThu loaiThu : listLoaiThu) {
                cboLoaichi.addItem(loaiThu.getTenloaithu());
            }
        }
    }
    ...
    private void addToList() {
        ...
        for (Object[] x : listObject) {
            if (Integer.parseInt(x[0].toString()) == listLoaiThu.get(cboLoaichi.getSelectedIndex()).getMaloaithu()) {
        ...
        tmp[0] = listLoaiThu.get(cboLoaichi.getSelectedIndex()).getMaloaithu();
        tmp[1] = listLoaiThu.get(cboLoaichi.getSelectedIndex()).getTenloaithu();
    ...
    private void insertHoaDonChi() {
        ...
        hoaDonThu.setNguoiDung(ShareHelper.nguoiDung);
        hoaDonThu.setNgaythu(ngayGio);
        if (new HoaDonThuDAO().addHoaDonThu(hoaDonThu)) {
            int mahd = new HoaDonThuDAO().getLastHoaDonThu().getIdhdthu();
            for (Object[] x : listObject) {
                ChiTietThu chiTietThu = new ChiTietThu();
                chiTietThu.setId(new ChiTietThuId(mahd, Integer.parseInt(x[0].toString())));
                chiTietThu.setSotien(Integer.parseInt(x[2].toString()));
                chiTietThu.setMota(x[3].toString());
                new ChiTietThuDAO().addChiTietThu(chiTietThu);
            }
            JOptionPane.showMessageDialog(this, "Thêm thành công", "Scuccess", JOptionPane.INFORMATION_MESSAGE);
            PanelHoaDonThu.panelHoaDonThu.loadHoaDon();
            this.dispose();
        } else {
